...
function initEditor(selector:string) {
    tinymce.init({
        selector: selector,
        height: 600,
        ...
        setup: function (ed) {
            ...
            ed.addCommand('insertVideo', function (ui, v) {
                swal({
                    ...
                    var result = '<p><iframe class="youtube-player" width="420" height="315" src="https://www.youtube.com/embed/' + /*youtube_parser(inputValue) +*/ '" frameborder="0" allowfullscreen=""></iframe></p>';
            ...
            ed.on('init', function (ed) {
                tinyMCE.activeEditor.setContent(/*markdownHTML*/);
            });
        }
    });
}