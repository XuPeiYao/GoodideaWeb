...
app.controller('search', function ($scope, $sce, $uibModal) {
    return __awaiter(this, void 0, void 0, function* () {
        $scope.bannerList = yield goodidea.Banner.getBannerList();
        if (queryString['q'])
            $scope.keyword = queryString['q'];
        ...
        $scope.loadNextPage = () => __awaiter(this, void 0, void 0, function* () {
            ...
            if ($scope.lastPageResult == null) {
                $scope.lastPageResult = yield goodidea.Project.search($scope.keyword, $scope.class == 'N' ? null : $scope.class, $scope.competition == 'N' ? null : $scope.competition, parseInt($scope.order));
            }
            else {
